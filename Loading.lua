...
local HawkLib = {
	Elements = {
		WideMenu = {
			...
			MinimizePosition = UDim2.new(0.944256783, 0, 0.35, 0),
...
TitleBar = Color3.fromRGB(182, 182, 182),
TabBefore = Color3.fromRGB(0, 0, 0),
TabAfter = Color3.fromRGB(0, 0, 0),
TitleTextColor = Color3.fromRGB(255, 255, 255),
TabTextColor = Color3.fromRGB(255, 255, 255),
TitleLineColor = Color3.fromRGB(182, 182, 182),
PageTitleColor = Color3.fromRGB(182, 182, 182),
...
NotificationNotifyColor = Color3.fromRGB(0, 0, 0),
...
function HawkLib:Window(Win)
	if _Hawk == "ohhahtuhthttouttpwuttuaunbotwo" then
		...
		Pages.Size = UDim2.new(0, 592, 0, 284)
